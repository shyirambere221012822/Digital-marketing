              ...
              if(mysqli_fetch_array($result) != $arr)
               {
                ...
                header("Refresh:0.2;url=Producers.php");
               }
...
<font color="red"size="5">UserName:<br><input type="text"Name="name"placeholder=""/></font><br><br>

<font color="red"face="Lato"size="5">Password:<br><input type="password"Name="pass"placeholder=""/></font><br><br><br>

<button><a href="Producers.php"><input type="submit" name="Login" value="Login"></a></button>
