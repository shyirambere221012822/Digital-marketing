...
$RePasscode=$_POST["FILE2"];
        ...
        $query="INSERT INTO signup(Names,UserName,Country,PhoneNo,Birthday,Sector,GENDER,Password,RetypedPassword) VALUES('$Fname','$Lname','$Country',$PhoneNo,'$birthday','$sector','$GENDER',$Passcode,$RePasscode)";
...
Retype-Password:</br><input type="password" size="10" name="FILE2" required><br></br>
      <button><a href="LogIn.php"target="_blank""><input type="submit" name="signup" value="signup"></a></button>
</b></font>     
</div>
  </main>
 <footer class="footer">
